// ==========================================
        ...
        class MenuPrincipal extends Phaser.Scene {
            ...
            preload() {
                ...
                // Spritesheets novos: Miguel possui 18 quadros em uma grade 6x3.
                // A imagem tem 866x288px; usando margem lateral de 1px, cada quadro fica 144x96px
                // sem invadir o padding das bordas. O robô usa grade perfeita 3x3 em 645x387px.
                this.load.spritesheet('miguel', 'miguel_sprites.png', {
                    frameWidth: 144,
                    frameHeight: 96,
                    margin: 1,
                    spacing: 0
                });
                this.load.spritesheet('robo', 'robo_sprites.png', {
                    frameWidth: 215,
                    frameHeight: 129,
                    spacing: 0
                });
        ...
        class Fase1 extends Phaser.Scene {
            ...
            create() {
                ...
                // CRIANDO O MIGUEL
                this.player = this.physics.add.sprite(50, 320, 'miguel', 0);
                this.player.setScale(0.95);
                this.player.body.setSize(52, 82);
                this.player.body.setOffset(46, 14);
                ...
                this.poeira = this.add.sprite(0, 0, 'miguel', 12).setVisible(false).setDepth(9);
                ...
                if (!this.anims.exists('walk')) {
                    this.anims.create({ key: 'walk', frames: this.anims.generateFrameNumbers('miguel', { start: 1, end: 2 }), frameRate: 8, repeat: -1 });
                    this.anims.create({ key: 'idle', frames: [ { key: 'miguel', frame: 0 } ], frameRate: 20 });
                    this.anims.create({ key: 'jump', frames: [ { key: 'miguel', frame: 3 } ], frameRate: 20 });
                    this.anims.create({ key: 'jump_double', frames: this.anims.generateFrameNumbers('miguel', { start: 4, end: 5 }), frameRate: 12, repeat: 0 });
                    this.anims.create({ key: 'attack', frames: this.anims.generateFrameNumbers('miguel', { start: 6, end: 8 }), frameRate: 16, repeat: 0 });
                    this.anims.create({ key: 'dust_effect', frames: this.anims.generateFrameNumbers('miguel', { start: 12, end: 17 }), frameRate: 18, repeat: 0 });
                    this.anims.create({ key: 'robo_patrol', frames: this.anims.generateFrameNumbers('robo', { start: 0, end: 2 }), frameRate: 8, repeat: -1 });
                    this.anims.create({ key: 'robo_damage', frames: this.anims.generateFrameNumbers('robo', { start: 3, end: 5 }), frameRate: 12, repeat: 0 });
                    this.anims.create({ key: 'robo_explosion', frames: this.anims.generateFrameNumbers('robo', { start: 6, end: 8 }), frameRate: 16, repeat: 0 });
                }
                this.vilao.anims.play('robo_patrol', true);
        ...
        class Fase2 extends Phaser.Scene {
            ...
            create() {
                ...
                this.add.text(400, 200, 'FASE 1 CONCLUÍDA!', { fontSize: '38px', fill: '#00FF66', fontStyle: 'bold' }).setOrigin(0.5);
                this.add.text(400, 290, `HERÓI: ${nome}`, { fontSize: '26px', fill: '#FFF' }).setOrigin(0.5);
                this.add.text(400, 340, `PONTOS: ${pontosFinal}`, { fontSize: '32px', fill: '#FFCC00', fontStyle: 'bold' }).setOrigin(0.5);

                let btnVoltar = this.add.text(400, 460, '[ JOGAR NOVAMENTE ]', { fontSize: '24px', fill: '#FFCC00', fontStyle: 'bold' }).setOrigin(0.5);
